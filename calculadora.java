 ...
 * </ul>
 *
 * <p><strong>Após a refatoração, os métodos desta classe são <strong>métodos puros</strong>,
...
public class calculadora {
     ...
     *
     * <p>Este método retorna o resultado da operação aritmética
     * {@code a - b}. Por ser uma operação simples, não requer
     * tratamento adicional.</p>
     *
     * @param a primeiro operando
     * @param b segundo operando
     ...
     *
     * <p>Realiza a multiplicação direta entre os parâmetros informados.
     * A operação é segura e não necessita de validações adicionais.</p>
     *
     * @param a primeiro operando
     * @param b segundo operando
     ...
     *
     * <p>Antes de realizar a divisão, este método verifica se o
     * divisor é igual a zero, lançando uma exceção caso isso
     * ocorra para evitar um erro em tempo de execução.</p>
     *
     * @param a dividendo
     * @param b divisor
